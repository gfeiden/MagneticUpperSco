...
{\bf The transition exhibited by theoretical magnetic models can be explained by a rapid thinning of outer convective envelopes in stars with masses above about 1.2 $M_{\odot}$ \citep[e.g.,][]{Iben1965}. Once a star reaches an effective temperature of 6\,000 K, it has a very small or non-existent convective envelope, independent of whether or not magnetic inhibition of convection is considered. In the absence of a convective envelope, magnetic inhibition of convection is irrelevant. Therefore, any differences between magnetic and standard stellar model isochrones above this effective temperature are the result of the magnetic field's influence on stellar structure at earlier evolutionary phases (i.e., delayed contraction). This naturally explains the convergence of the 10 Myr magnetic isochrone with the 10 Myr standard model isochrone near $6\,000$~K in Fig.~\ref{fig:ages}(b). 
It then seems reasonable to posit that the slope of the empirical HR diagram in this temperature domain contains information about the demise of surface convection zones, the growth of radiative cores, and the weakening of surface magnetic dynamo action in young, pre-main-sequence stars.}

{\bf The beginning of the transition between 4\,500 and 5\,000 K corresponds to magnetic models masses of 1.26 $M_{\odot}$ and 1.40 $M_{\odot}$. Magnetic models predict that these stars have radiative core masses between 75\% and 88\% of their total stellar mass, respectively (see Figure~\ref{fig:rad_core}a). The 1.40 $M_{\odot}$ model is of particular note, as Figure~\ref{fig:mrd} predicts that 1.40 $M_{\odot}$ stars are beginning to enter a brief period of radius inflation that accompanies the ignition of CN-cycle burning \citep{Iben1965}. Photospheric gas pressures rapidly drop during this phase of evolution. A rapid drop in photospheric gas pressure will bring about a rapid drop in surface equipartition magnetic field strengths. As expected, a rapid decrease in equipartition magnetic field strengths is observed among the data in Table~\ref{fig:equip_values} beginning around 1.40 $M_{\odot}$. Stars above 1.40 $M_{\odot}$ then become less sensitive to magnetic inhibition of convection because the magnetic fields are intrinsically weaker.}

{\bf However, disagreement between model predictions and the properties observed for F-type stars raises concerns that }

{\bf
Figure~\ref{fig:rad_core} compares predictions of radiative core masses as a function of stellar mass and effective temperature from standard models at 5 and 10 Myr (characteristic ages for cool and warm stars) and from magnetic models at 10 Myr. As a function of mass, magnetic models predict stars to have small radiative cores at 10 Myr, a result of delayed contraction. Stars of a given mass take longer to contract down the Hayashi track when magnetic inhibition of convection is included. Core temperatures required to initiate the formation of a radiative core are thus delayed. 
}

{\bf However, when comparing radiative core masses as a function of effective temperature, stars of a given effective temperature have significantly larger radiative core masses when magnetic fields are included.
}


{\bf % Not only for stars with M ~ 1.2... all intermediate mass stars above 0.28 Msun. 
Stars with masses above about $0.28\ M_{\odot}$ are predicted to, at least temporarily, form a small radiative core during their pre-main-sequence contraction. Release of gravitational potential energy as stars contract heats the gas causing radiative opacities to decrease and igniting fusion from the proton-proton ($p$-$p$) chain \citep{Henyey1955}. Stars with masses below about $1.2\ M_{\odot}$ continue to contract until energy production from the $p$-$p$ chain is sufficient to stabilize the core (and thus the star) against further contraction. However, above $1.2\ M_{\odot}$, core temperatures become sufficiently hot enough to produce hydrogen burning via the CN-cycle at an appreciable level. Increased energy production from the CN-cycle, while initially insufficient to support the core against gravitational contraction, causes the radiative core to continue growing and the convective envelope to continue shrinking. Increasing energy production from the CN-cycle and $p$-$p$ chain causes a star's outer layers are predicted to expand while the core's contraction slows. Eventually, the CN-cycle reaches equilibrium, a convective core develops, the radius expansion is reversed, and the convective envelope disappears entirely \citep{Iben1965,Bodenheimer1965}. }

{\bf 
To fully understand the model-predicted transition in Fig.~\ref{fig:ages}(a) and the reasons why magnetic models do not entirely reproduce the morphology of the empirical transition, it is important to consider how the magnetic field evolves as a star's convective envelope shrinks.
Prior to ignition of the CN-cycle, a thinning of the convective envelope means magnetic fields of a given strength will have a larger impact on the thermal structure of the super-adiabatic region. However, a restructuring of the super-adiabatic layers in a star with a thin convective envelope has less of an impact on the thermal structure of the deeper underlying layers, which are assumed to be in radiative equilibrium, than for a star whose interior is largely convective. The thinning of the convective envelope is also accompanied by a drop in the surface gas pressure as the star's radius inflates thereby lowering the permitted equipartition magnetic field strength. The combination of these two effects suggests that the transition from a magnetic sequence to a non-magnetic sequence should coincide with the disappearance of the convective envelope.} % confirm discussion of super-adiabatic layers

{\bf Assuming that a change in slope of the empirical HR diagram is observed at 4\,500 K, 
...
{\bf While this behavior is expected in the magnetic models, it does not need to necessarily correspond to the observed transition. General agreement between the behavior of the magnetic model isochrone and the observed stellar locus provides evidence that magnetic inhibition of convection is the mechanism responsible for the age discrepancy between the high- and low-mass stellar populations. However, it is clear that this statement only holds with respect to the plausible identification of a general mechanism as the models fail to reproduce the precise morphology at the magnetic sequence turn-off.}
